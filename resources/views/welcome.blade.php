...
<body class="leading-normal tracking-normal text-gray-900" style="font-family: 'Source Sans Pro', sans-serif; background-size:cover; background-image:url('images/background.png')">
    ...
    <div class="h-screen pb-14 bg-right bg-cover" style="background-image:url('bg.svg');">
        ...
        <div class="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
                <h1 class="my-4 text-3xl md:text-5xl text-green-500 font-bold leading-tight text-center md:text-left slide-in-bottom-h1">Welcome to the System</h1>
                <p class="leading-normal text-green-600 text-base md:text-2xl mb-8 text-center md:text-left slide-in-bottom-subtitle">Full Company Management Facility</p>
            ...
            <!--Right Col-->
            <div class="w-full xl:w-2/5 py-6 overflow-y-hidden pl-10">
                <form method="get" action="/register" class="mt-10">

                    <div class="flex mt-7 justify-center w-full">
                        <button class="bg-blue-500 w-1/2 py-3 rounded-xl text-white shadow-xl hover:shadow-inner focus:outline-none transition duration-500 ease-in-out  transform hover:-translate-x hover:scale-105">
                            Register here
                        </button>
                    </div>
